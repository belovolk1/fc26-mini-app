...
> = {
  en: {
    ...
    guestName: 'Guest',
    homeHeroHeadline: 'FC 26 Ladder & Tournaments — Matchmaking, ELO Rating, Stats',
    homeHeroDesc: 'FC Area: FC 26 ladder matchmaking and tournaments. Find opponents for Ultimate Team and Original Teams, play ranked matches, climb the ELO rating and track your stats.',
  ...
  ro: {
    ...
    guestName: 'Vizitator',
    homeHeroHeadline: 'FC 26 Ladder și Turnee — Matchmaking, Rating ELO, Statistici',
    homeHeroDesc: 'FC Area: matchmaking ladder și turnee FC 26. Găsește adversari pentru Ultimate Team și Original Teams, joacă meciuri clasate, urcă în rating ELO și urmărește statisticile.',
  ...
  ru: {
    ...
    guestName: 'Гость',
    homeHeroHeadline: 'FC 26 Турниры и ладдер — матчмейкинг, рейтинг ELO, статистика',
    homeHeroDesc: 'FC Area: матчмейкинг и турниры FC 26. Ищи соперников для Ultimate Team и Original Teams, играй в рейтинговые матчи, поднимайся в рейтинге ELO и следи за статистикой.',
